...
const char* serverName = "http://windspotbelgium.com/FBVL2/post-data.php";
char resource[] = "/FBVL2/post-data.php";
char  serverSleepInfo[] = "/FBVL2/json/Sleep.php";
char  serverGirouetteInfo[] = "/FBVL2/json/GirouetteCal.php";
const int  port = 80;
...
// Analog input
const int Pin_batterie =  A6; //pin34
const int Pin_Davis_ana =  A18;  // pin25  (davis green wire)

// Digital input
const int Pin_Davis_pulse =  2;  // pin2(davis black wire)

// Digital output
const int Pin_Reset = 14;  // pin14
