...
const char* serverName = "http://windspotbelgium.com/FBVL1/post-data.php";
char resource[] = "/FBVL1/post-data.php";
char  serverSleepInfo[] = "/FBVL1/json/Sleep.php";
char  serverGirouetteInfo[] = "/FBVL1/json/GirouetteCal.php";
const int  port = 80;
...
// Analog input
//const int Pin_batterie =  A7; //pin35
const int Pin_Davis_ana =  A18;  // pin25  (davis green wire)

// Digital input
const int Pin_Davis_pulse =  32;  // pin2(davis black wire)

// Digital output
const int Pin_Reset = 35;  // pin35
...
void setup() {
  ...
  counterInterval = ResetDelay * 60 * 60 * 1000; // 12 hours in milliseconds
